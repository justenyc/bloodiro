...
namespace Quickjam.Enemy.Wildeman
{
    ...
    public class Enemy_Wildeman : Enemy
    {
        [System.Serializable]
        ...
        Enemy_Wildeman_State _currentState;
        ...
        private void Start()
        {
            _currentState = new Enemy_Wildeman_Patrol(this, transform.position);
        ...
        public void SetState(Enemy_Wildeman_State newState)
        {
