...
namespace Quickjam.Enemy.Hellvark
{
    ...
    public class Enemy_Hellvark : Enemy
    {
        [System.Serializable]
        public class StalkStateProperties
        {
            [Tooltip("How long it takes for the Hellvark to de-aggro")]
        ...
        {
            [Tooltip("How long the Hellvark waits before determining a new position after it reaches a patrol target position")] 
        ...
        Enemy_Hellvark_State _currentState;
        ...
        private void Start()
        {
            _currentState = new Enemy_Hellvark_Patrol(this, transform.position);
        ...
        public void SetState(Enemy_Hellvark_State newState)
        {
